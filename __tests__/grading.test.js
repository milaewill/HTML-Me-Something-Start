...
describe("Grading Tests: ", function () {
   ...
   it("CSS funParagraph class is pale violet red", function () {
      expect(css.includes(".funParagraph")).toBe(true);
      expect(css.includes("color: palevioletred;")).toBe(true);
   })

   it("CSS mainHeading id is white", function () {
      expect(css.includes("#mainHeading")).toBe(true);
      expect(css.includes("color: white;")).toBe(true);
   })
